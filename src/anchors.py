"""
Code adapted from: 
https://github.com/biomed-AI/COVID19-CT/blob/main/local_traniner/model/core/anchors.py
"""
...
def generate_default_anchor_maps(
    anchors_setting=None, input_shape=INPUT_SIZE, setting="small"
):
    """
